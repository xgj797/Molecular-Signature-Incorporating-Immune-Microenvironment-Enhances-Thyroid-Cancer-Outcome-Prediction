...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_raw/result/X2227AC4'
...
for i in {1..5}; do 
  echo iteration $i ...
  cp -f /data/h_vivian_weiss/2227/2227-AC-4-TGACCAAT-TCTTTCCC_S12_R1_001.fastq.gz 2227-AC-4-TGACCAAT-TCTTTCCC_S12_R1_001.fastq.gz
...
for i in {1..5}; do 
  echo iteration $i ...
  cp -f /data/h_vivian_weiss/2227/2227-AC-4-TGACCAAT-TCTTTCCC_S12_R2_001.fastq.gz 2227-AC-4-TGACCAAT-TCTTTCCC_S12_R2_001.fastq.gz
...
fastqc  --extract -t 2 -o `pwd` "2227-AC-4-TGACCAAT-TCTTTCCC_S12_R1_001.fastq.gz" "2227-AC-4-TGACCAAT-TCTTTCCC_S12_R2_001.fastq.gz" 2> >(tee X2227AC4.fastqc.stderr.log >&2)
