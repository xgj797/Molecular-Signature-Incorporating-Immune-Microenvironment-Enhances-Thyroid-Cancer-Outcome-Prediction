...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_raw/result/X4303CP67'
...
for i in {1..5}; do 
  echo iteration $i ...
  cp -f /data/h_vivian_weiss/4303/4303-CP-67-ATAACGCC-CAGGTTCA_S102_R1_001.fastq.gz 4303-CP-67-ATAACGCC-CAGGTTCA_S102_R1_001.fastq.gz
...
for i in {1..5}; do 
  echo iteration $i ...
  cp -f /data/h_vivian_weiss/4303/4303-CP-67-ATAACGCC-CAGGTTCA_S102_R2_001.fastq.gz 4303-CP-67-ATAACGCC-CAGGTTCA_S102_R2_001.fastq.gz
...
fastqc  --extract -t 2 -o `pwd` "4303-CP-67-ATAACGCC-CAGGTTCA_S102_R1_001.fastq.gz" "4303-CP-67-ATAACGCC-CAGGTTCA_S102_R2_001.fastq.gz" 2> >(tee X4303CP67.fastqc.stderr.log >&2)
