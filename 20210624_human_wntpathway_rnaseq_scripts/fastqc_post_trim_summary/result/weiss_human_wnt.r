rm(list=ls()) 
outFile='weiss_human_wnt.countInFastQcVis.Result'
parSampleFile1=''
parSampleFile2=''
parSampleFile3=''
parFile1='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_raw_summary/result/weiss_human_wnt.FastQC.reads.tsv'
parFile2='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim_summary/result/weiss_human_wnt.FastQC.reads.tsv'
parFile3=''


setwd('/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim_summary/result')
