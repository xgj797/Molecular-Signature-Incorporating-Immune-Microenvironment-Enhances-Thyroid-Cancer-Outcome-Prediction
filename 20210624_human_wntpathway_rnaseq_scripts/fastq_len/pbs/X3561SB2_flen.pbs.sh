...
echo /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.1.fastq.short.gz      
if [[ ! -s /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.1.fastq.short.gz ]]; then
  echo file not exists: /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.1.fastq.short.gz
  touch $res_dir/X3561SB2_clipped.1.fastq.short.gz.not.exist
  rm X3561SB2_clipped.1.fastq.gz X3561SB2_clipped.2.fastq.gz X3561SB2_clipped.1.fastq.short.gz
  exit 1
fi

for i in {1..5}; do 
  echo iteration $i ...
  cp -f /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.1.fastq.short.gz X3561SB2_clipped.1.fastq.short.gz
  diff /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.1.fastq.short.gz X3561SB2_clipped.1.fastq.short.gz
  status=$?
  if [[ $status -eq 0 ]]; then
    break
  fi
...
if [[ $status -ne 0 ]]; then
  echo file copied is not idential to original file, quit.
  touch $res_dir/X3561SB2_clipped.1.fastq.short.gz.copy.failed
  rm X3561SB2_clipped.1.fastq.gz X3561SB2_clipped.2.fastq.gz X3561SB2_clipped.1.fastq.short.gz
  exit 1
fi

echo /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.2.fastq.short.gz      
if [[ ! -s /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.2.fastq.short.gz ]]; then
  echo file not exists: /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.2.fastq.short.gz
  touch $res_dir/X3561SB2_clipped.2.fastq.short.gz.not.exist
  rm X3561SB2_clipped.1.fastq.gz X3561SB2_clipped.2.fastq.gz X3561SB2_clipped.1.fastq.short.gz X3561SB2_clipped.2.fastq.short.gz
  exit 1
fi

for i in {1..5}; do 
  echo iteration $i ...
  cp -f /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.2.fastq.short.gz X3561SB2_clipped.2.fastq.short.gz
  diff /scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/cutadapt/result/X3561SB2_clipped.2.fastq.short.gz X3561SB2_clipped.2.fastq.short.gz
  status=$?
  if [[ $status -eq 0 ]]; then
    break
  fi
...
if [[ $status -ne 0 ]]; then
  echo file copied is not idential to original file, quit.
  touch $res_dir/X3561SB2_clipped.2.fastq.short.gz.copy.failed
  rm X3561SB2_clipped.1.fastq.gz X3561SB2_clipped.2.fastq.gz X3561SB2_clipped.1.fastq.short.gz X3561SB2_clipped.2.fastq.short.gz
  exit 1
fi
...
python3 /data/cqs/softwares/ngsperl/lib/CQS/../QC/fastq_len.py   -i X3561SB2_clipped.1.fastq.gz,X3561SB2_clipped.2.fastq.gz,X3561SB2_clipped.1.fastq.short.gz,X3561SB2_clipped.2.fastq.short.gz -o X3561SB2.len
