...
rootdir<-"/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/deseq2_proteincoding_genetable/result"
inputfile<-"weiss_human_wnt.define" 
...
outputPdf<-TRUE;outputPng<-TRUE;outputTIFF<-FALSE;showVolcanoLegend<-TRUE;usePearsonInHCA<-TRUE;showLabelInPCA<-TRUE;top25cvInHCA<-FALSE;
cooksCutoff<-0.99
