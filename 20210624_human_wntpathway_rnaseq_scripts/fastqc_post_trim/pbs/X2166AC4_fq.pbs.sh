...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X2166AC4'
...
fastqc  --extract -t 2 -o `pwd` "X2166AC4_clipped.1.fastq.gz" "X2166AC4_clipped.2.fastq.gz" 2> >(tee X2166AC4.fastqc.stderr.log >&2)
