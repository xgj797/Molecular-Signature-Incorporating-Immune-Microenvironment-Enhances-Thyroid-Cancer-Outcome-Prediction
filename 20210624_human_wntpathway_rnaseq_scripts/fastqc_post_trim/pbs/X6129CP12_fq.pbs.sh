...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X6129CP12'
...
fastqc  --extract -t 2 -o `pwd` "X6129CP12_clipped.1.fastq.gz" "X6129CP12_clipped.2.fastq.gz" 2> >(tee X6129CP12.fastqc.stderr.log >&2)
