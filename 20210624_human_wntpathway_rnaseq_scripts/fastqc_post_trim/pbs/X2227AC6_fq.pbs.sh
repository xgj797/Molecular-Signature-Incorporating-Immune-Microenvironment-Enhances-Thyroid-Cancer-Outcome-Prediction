...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X2227AC6'
...
fastqc  --extract -t 2 -o `pwd` "X2227AC6_clipped.1.fastq.gz" "X2227AC6_clipped.2.fastq.gz" 2> >(tee X2227AC6.fastqc.stderr.log >&2)
