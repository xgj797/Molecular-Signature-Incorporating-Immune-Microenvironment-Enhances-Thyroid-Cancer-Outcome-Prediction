...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X3607SB8'
...
fastqc  --extract -t 2 -o `pwd` "X3607SB8_clipped.1.fastq.gz" "X3607SB8_clipped.2.fastq.gz" 2> >(tee X3607SB8.fastqc.stderr.log >&2)
