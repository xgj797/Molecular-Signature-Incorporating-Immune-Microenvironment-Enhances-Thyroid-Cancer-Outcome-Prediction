...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X3561SB2'
...
fastqc  --extract -t 2 -o `pwd` "X3561SB2_clipped.1.fastq.gz" "X3561SB2_clipped.2.fastq.gz" 2> >(tee X3561SB2.fastqc.stderr.log >&2)
