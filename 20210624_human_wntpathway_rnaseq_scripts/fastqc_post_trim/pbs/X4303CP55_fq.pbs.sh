...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X4303CP55'
...
fastqc  --extract -t 2 -o `pwd` "X4303CP55_clipped.1.fastq.gz" "X4303CP55_clipped.2.fastq.gz" 2> >(tee X4303CP55.fastqc.stderr.log >&2)
