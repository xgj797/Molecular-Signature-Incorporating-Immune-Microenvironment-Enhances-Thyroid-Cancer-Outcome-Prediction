...
res_dir='/scratch/weissvl/shengq2/20210624_human_wntpathway_rnaseq/fastqc_post_trim/result/X1623AC1'
...
fastqc  --extract -t 2 -o `pwd` "X1623AC1_clipped.1.fastq.gz" "X1623AC1_clipped.2.fastq.gz" 2> >(tee X1623AC1.fastqc.stderr.log >&2)
