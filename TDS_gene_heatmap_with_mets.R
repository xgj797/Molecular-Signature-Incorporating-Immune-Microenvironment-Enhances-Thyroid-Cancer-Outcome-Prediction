...
# Set directory
setwd("/Users/georgexu/Dropbox/Vanderbilt\ Grad\ School/Lab/Projects/Data/RNA\ seq\ processing/9-30-22\ -\ Gene\ expression\ heatmaps/9-30-22\ -\ TDS\ gene\ heatmap\ with\ mets\ using\ ComplexHeatmap")
...
meta <- read.csv("meta_diag_and_CAF-EPIC_sort_thyroid_AND_met_remove_outlier4303CP41_and_MNG_and_HT_merge_E_and_I_FVPTCs_WITHOUT_HTPTCs_9-30-22.csv", header=TRUE, row.names=1, as.is=TRUE)
