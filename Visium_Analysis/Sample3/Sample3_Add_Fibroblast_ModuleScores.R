...
# Date: 22-0913
# Goal: read in pre-processed Sample3 and add fibroblast module scores (normal, myCAF, iCAF)
...
NormalFibroblastSpatial <- SpatialFeaturePlot(Sample3, features = c("Kieffer_Normal_Fibroblast1"))
ggsave("outputs/Sample3_Normal_Fibroblast_ModuleScore.png",
...
MyCAFFibroblastSpatial <- SpatialFeaturePlot(Sample3, features = c("Kieffer_myCAF_Combined1"))
ggsave("outputs/Sample3_myCAF_ModuleScore.png",
...
iCAFFibroblastSpatial <- SpatialFeaturePlot(Sample3, features = c("Kieffer_iCAF_Combined1"))
ggsave("outputs/Sample3_iCAF_ModuleScore.png",
