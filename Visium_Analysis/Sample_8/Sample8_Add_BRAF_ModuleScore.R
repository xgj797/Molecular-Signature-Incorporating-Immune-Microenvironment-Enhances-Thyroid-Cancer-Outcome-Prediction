...
# Date: 22-0913
# Goal: read in pre-processed Sample8 and add BRAF as a module score
...
# Add BRAF Gene Score to Sample8
Sample8 <- AddModuleScore(object = Sample8,
                          features = BRAF_Genes_List,
                          name = "BRAF_Score")

# Print BRAF Spatial Feature Plot
BRAF_Spatial <- SpatialFeaturePlot(Sample8, features = c("BRAF_Score1"))
ggsave("outputs/Sample8_ModuleScores/Sample8_BRAF_ModuleScore.png",
       BRAF_Spatial,
