...
# Date: 22-0913
# Goal: read in pre-processed Sample8 and add PI3K-AKT-mTOR as a module score
...
PI3K_Spatial <- SpatialFeaturePlot(Sample8, features = c("PI3K_Score1"))
ggsave("outputs/Sample8_ModuleScores/Sample8_PI3K_ModuleScore.png",
       PI3K_Spatial,
