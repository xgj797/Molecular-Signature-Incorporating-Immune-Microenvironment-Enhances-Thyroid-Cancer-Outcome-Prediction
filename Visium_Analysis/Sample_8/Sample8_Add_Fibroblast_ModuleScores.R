...
# Date: 22-0913
# Goal: read in pre-processed Sample8 and add fibroblast module scores (normal, myCAF, iCAF)
...
NormalFibroblastSpatial <- SpatialFeaturePlot(Sample8, features = c("Kieffer_Normal_Fibroblast1"))
ggsave("outputs/Sample8_Normal_Fibroblast_ModuleScore.png",
...
MyCAFFibroblastSpatial <- SpatialFeaturePlot(Sample8, features = c("Kieffer_myCAF_Combined1"))
ggsave("outputs/Sample8_myCAF_ModuleScore.png",
...
iCAFFibroblastSpatial <- SpatialFeaturePlot(Sample8, features = c("Kieffer_iCAF_Combined1"))
ggsave("outputs/Sample8_iCAF_ModuleScore.png",
