...
# Date: 22-0913
# Goal: read in pre-processed Sample6 and add BRAF as a module score
...
# Add BRAF Gene Score to Sample6
Sample6 <- AddModuleScore(object = Sample6,
                          features = BRAF_Genes_List,
                          name = "BRAF_Score")

# Print BRAF Spatial Feature Plot
BRAF_Spatial <- SpatialFeaturePlot(Sample6, features = c("BRAF_Score1"))
ggsave("outputs/Sample6_ModuleScores/Sample6_BRAF_ModuleScore.png",
       BRAF_Spatial,
