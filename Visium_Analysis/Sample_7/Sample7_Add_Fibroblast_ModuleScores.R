...
# Date: 22-0913
# Goal: read in pre-processed Sample7 and add fibroblast module scores (normal, myCAF, iCAF)
...
# Load processed Sample7
Sample7 <- readRDS(file = "Data_in_Use/Sample7/Sample7_Clustered_0.3Res.rds")
...
Sample7 <- AddModuleScore(object = Sample7,
                          features = Kieffer_Normal_Fibroblast,
                          name = 'Kieffer_Normal_Fibroblast')
NormalFibroblastSpatial <- SpatialFeaturePlot(Sample7, features = c("Kieffer_Normal_Fibroblast1"))
ggsave("outputs/Sample7_Normal_Fibroblast_ModuleScore.png",
...
MyCAFFibroblastSpatial <- SpatialFeaturePlot(Sample7, features = c("Kieffer_myCAF_Combined1"))
ggsave("outputs/Sample7_myCAF_ModuleScore.png",
...
iCAFFibroblastSpatial <- SpatialFeaturePlot(Sample7, features = c("Kieffer_iCAF_Combined1"))
ggsave("outputs/Sample7_iCAF_ModuleScore.png",
