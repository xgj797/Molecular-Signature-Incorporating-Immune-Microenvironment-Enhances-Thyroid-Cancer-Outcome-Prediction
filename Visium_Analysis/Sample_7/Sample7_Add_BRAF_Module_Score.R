...
# Date: 22-0913
# Goal: read in pre-processed Sample7 and add BRAF as a module score
...
# Add BRAF Gene Score to Sample7
Sample7 <- AddModuleScore(object = Sample7,
                          features = BRAF_Genes_List,
                          name = "BRAF_Score")

# Print BRAF Spatial Feature Plot
BRAF_Spatial <- SpatialFeaturePlot(Sample7, features = c("BRAF_Score1"))
ggsave("outputs/Sample7_ModuleScores/Sample7_BRAF_ModuleScore.png",
       BRAF_Spatial,
