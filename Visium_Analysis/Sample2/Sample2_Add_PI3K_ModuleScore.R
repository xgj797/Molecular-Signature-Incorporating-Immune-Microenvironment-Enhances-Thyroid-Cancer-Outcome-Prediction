...
# Date: 22-0913
# Goal: read in pre-processed Sample2 and add PI3K-AKT-mTOR as a module score
...
PI3K_Spatial <- SpatialFeaturePlot(Sample2, features = c("PI3K_Score1"))
ggsave("outputs/Sample2_ModuleScores/Sample2_PI3K_ModuleScore.png",
       PI3K_Spatial,
