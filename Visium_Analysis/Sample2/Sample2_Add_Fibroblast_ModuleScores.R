...
# Date: 22-0913
# Goal: read in pre-processed Sample2 and add fibroblast module scores (normal, myCAF, iCAF)
...
NormalFibroblastSpatial <- SpatialFeaturePlot(Sample2, features = c("Kieffer_Normal_Fibroblast1"))
ggsave("outputs/Sample2_Normal_Fibroblast_ModuleScore.png",
...
MyCAFFibroblastSpatial <- SpatialFeaturePlot(Sample2, features = c("Kieffer_myCAF_Combined1"))
ggsave("outputs/Sample2_myCAF_ModuleScore.png",
...
iCAFFibroblastSpatial <- SpatialFeaturePlot(Sample2, features = c("Kieffer_iCAF_Combined1"))
ggsave("outputs/Sample2_iCAF_ModuleScore.png",
