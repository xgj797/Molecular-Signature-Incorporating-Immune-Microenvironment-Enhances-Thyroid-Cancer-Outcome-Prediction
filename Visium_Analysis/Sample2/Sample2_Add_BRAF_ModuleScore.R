...
# Date: 22-0913
# Goal: read in pre-processed Sample2 and add BRAF as a module score
...
# Add BRAF Gene Score to Sample2
Sample2 <- AddModuleScore(object = Sample2,
                                features = BRAF_Genes_List,
                                name = "BRAF_Score")

# Print BRAF Spatial Feature Plot
BRAF_Spatial <- SpatialFeaturePlot(Sample2, features = c("BRAF_Score1"))
ggsave("outputs/Sample2_ModuleScores/Sample2_BRAF_ModuleScore.png",
       BRAF_Spatial,
