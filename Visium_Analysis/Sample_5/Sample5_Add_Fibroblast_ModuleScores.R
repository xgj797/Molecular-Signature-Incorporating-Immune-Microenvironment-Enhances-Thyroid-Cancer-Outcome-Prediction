...
# Date: 22-0913
# Goal: read in pre-processed Sample5 and add fibroblast module scores (normal, myCAF, iCAF)
...
NormalFibroblastSpatial <- SpatialFeaturePlot(Sample5, features = c("Kieffer_Normal_Fibroblast1"))
ggsave("outputs/Sample5_Normal_Fibroblast_ModuleScore.png",
...
MyCAFFibroblastSpatial <- SpatialFeaturePlot(Sample5, features = c("Kieffer_myCAF_Combined1"))
ggsave("outputs/Sample5_myCAF_ModuleScore.png",
...
iCAFFibroblastSpatial <- SpatialFeaturePlot(Sample5, features = c("Kieffer_iCAF_Combined1"))
ggsave("outputs/Sample5_iCAF_ModuleScore.png",
