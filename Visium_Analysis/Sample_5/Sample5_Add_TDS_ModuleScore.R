...
# Date: 22-0913
# Goal: read in pre-processed Sample5 and add TDS as a module score
...
TDS_Spatial <- SpatialFeaturePlot(Sample5, features = c("TDS1"))
ggsave("outputs/Sample5_ModuleScores/22-0913_Sample5_TDS_ModuleScore.png",
       TDS_Spatial,
