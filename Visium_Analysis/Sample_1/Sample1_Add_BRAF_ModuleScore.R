...
# Date: 22-0913
# Goal: read in pre-processed Sample1 and add BRAF as a module score
...
# Add BRAF Gene Score to Sample1
Sample1 <- AddModuleScore(object = Sample1,
                          features = BRAF_Genes_List,
                          name = "BRAF_Score")

# Print BRAF Spatial Feature Plot
BRAF_Spatial <- SpatialFeaturePlot(Sample1, features = c("BRAF_Score1"))
ggsave("outputs/Sample1_ModuleScores/Sample1_BRAF_ModuleScore.png",
       BRAF_Spatial,
