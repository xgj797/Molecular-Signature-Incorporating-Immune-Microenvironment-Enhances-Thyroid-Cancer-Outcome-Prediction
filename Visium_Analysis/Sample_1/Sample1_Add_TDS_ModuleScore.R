...
# Date: 22-0913
# Goal: read in pre-processed Sample1 and add TDS as a module score
...
TDS_Spatial <- SpatialFeaturePlot(Sample1, features = c("TDS1"))
ggsave("outputs/Sample1_ModuleScores/22-0913_Sample1_TDS_ModuleScore.png",
       TDS_Spatial,
