...
#                column_order = 1:32, # holds column order in the order fed in by the oncoplot matrix, will need adjusting depending on cohort subsetting used (see environment, Clinical_Data_Oncoplot_Restricted, number of obs.)
                column_order = 1:10, # holds column order in the order fed in by the oncoplot matrix, will need adjusting depending on cohort subsetting used (see environment, Clinical_Data_Oncoplot_Restricted, number of obs.)
