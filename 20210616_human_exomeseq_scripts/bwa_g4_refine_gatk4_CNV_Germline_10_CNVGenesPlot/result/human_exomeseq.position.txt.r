inputFile<-"human_exomeseq.position.txt"
outputPrefix<-"human_exomeseq.position.txt"
sizeFactorFile<-"/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_gatk4_CNV_Germline_08_SizeFactor/result/human_exomeseq.txt.sizefactor"
...
setwd('/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_gatk4_CNV_Germline_10_CNVGenesPlot/result')
cat(inputFile, "\n")
