rm(list=ls()) 
outFile='human_exomeseq.countInFastQcVis.Result'
parSampleFile1=''
parSampleFile2=''
parSampleFile3=''
parFile1='/scratch/weissvl/shengq2/20210616_human_exomeseq/fastqc_raw_summary/result/human_exomeseq.FastQC.reads.tsv'
parFile2='/scratch/weissvl/shengq2/20210616_human_exomeseq/fastqc_post_trim_summary/result/human_exomeseq.FastQC.reads.tsv'
parFile3=''


setwd('/scratch/weissvl/shengq2/20210616_human_exomeseq/fastqc_post_trim_summary/result')
