...
cd '/scratch/weissvl/shengq2/20210616_human_exomeseq/muTect2_06_toMAF/result'

set -o pipefail



Rscript --vanilla /data/cqs/softwares/ngsperl/lib/Annotation/annovar2maf.r /scratch/weissvl/shengq2/20210616_human_exomeseq/muTect2_05_filter/result/human_exomeseq.freq0.001.filtered.tsv human_exomeseq.freq0.001.filtered.tsv.tmp hg38
...
Rscript --vanilla /data/cqs/softwares/ngsperl/lib/Annotation/annovar2maf.r /scratch/weissvl/shengq2/20210616_human_exomeseq/muTect2_05_filter/result/human_exomeseq.freq0.01.filtered.tsv human_exomeseq.freq0.01.filtered.tsv.tmp hg38
...
Rscript --vanilla /data/cqs/softwares/ngsperl/lib/Annotation/annovar2maf.r /scratch/weissvl/shengq2/20210616_human_exomeseq/muTect2_05_filter/result/human_exomeseq.freq0.1.filtered.tsv human_exomeseq.freq0.1.filtered.tsv.tmp hg38
