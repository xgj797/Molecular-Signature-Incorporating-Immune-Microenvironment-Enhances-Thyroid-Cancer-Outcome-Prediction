...
echo localize end at `date`
 ...
 gatk ValidateSamFile -I P4601_CP_05.sortedByCoord.bam -O P4601_CP_05.txt --IGNORE_WARNINGS --SKIP_MATE_VALIDATION --VALIDATE_INDEX false --INDEX_VALIDATION_STRINGENCY NONE
