...
echo localize end at `date`
 ...
 gatk ValidateSamFile -I P1809_AC_023.sortedByCoord.bam -O P1809_AC_023.txt --IGNORE_WARNINGS --SKIP_MATE_VALIDATION --VALIDATE_INDEX false --INDEX_VALIDATION_STRINGENCY NONE
