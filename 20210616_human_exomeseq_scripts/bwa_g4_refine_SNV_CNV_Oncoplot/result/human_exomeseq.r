...
parSampleFile3=''
parFile1='/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_gatk4_CNV_Germline_11_AnnotationGenesPlot/result/human_exomeseq.position.txt.slim'
parFile2=''
parFile3=''
outputDirectory='.'


setwd('/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_SNV_CNV_Oncoplot/result')
