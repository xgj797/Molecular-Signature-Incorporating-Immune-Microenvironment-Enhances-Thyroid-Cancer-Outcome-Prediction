...
gatk --java-options "-Xmx40G" CollectReadCounts  \
  ...
  --input /scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine/result/P3544_SB_34.rmdup.recal.bam \
  --reference /data/cqs/references/broad/hg38/v0/Homo_sapiens_assembly38.fasta \
  --format HDF5 \
  --interval-merging-rule OVERLAPPING_ONLY \
  --output P3544_SB_34.count.hdf5

status=$?
if [[ $status -ne 0 ]]; then
  touch P3544_SB_34.failed
  rm -f P3544_SB_34.count.hdf5
else
