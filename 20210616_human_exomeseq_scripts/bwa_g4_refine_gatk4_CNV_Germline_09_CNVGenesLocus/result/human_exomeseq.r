...
parSampleFile2=''
parSampleFile3=''
parFile1='/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_gatk4_CNV_Germline_07_CombineGCNV/result/human_exomeseq.txt'
parFile2=''
parFile3=''
host="www.ensembl.org";dataset="hsapiens_gene_ensembl";symbolKey="hgnc_symbol";addChr=1

setwd('/scratch/weissvl/shengq2/20210616_human_exomeseq/bwa_g4_refine_gatk4_CNV_Germline_09_CNVGenesLocus/result')
