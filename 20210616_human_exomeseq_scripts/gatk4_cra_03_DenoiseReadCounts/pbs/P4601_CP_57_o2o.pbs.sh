...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P4601_CP_57.counts.hdf5 \
    --standardized-copy-ratios P4601_CP_57.standardizedCR.tsv \
    --denoised-copy-ratios P4601_CP_57.denoisedCR.tsv \
