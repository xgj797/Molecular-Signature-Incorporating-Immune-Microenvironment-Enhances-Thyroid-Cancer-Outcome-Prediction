...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P1988_AC_08.counts.hdf5 \
    --standardized-copy-ratios P1988_AC_08.standardizedCR.tsv \
    --denoised-copy-ratios P1988_AC_08.denoisedCR.tsv \
