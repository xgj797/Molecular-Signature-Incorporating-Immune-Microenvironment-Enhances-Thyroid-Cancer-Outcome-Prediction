...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P1809_AC_075.counts.hdf5 \
    --standardized-copy-ratios P1809_AC_075.standardizedCR.tsv \
    --denoised-copy-ratios P1809_AC_075.denoisedCR.tsv \
