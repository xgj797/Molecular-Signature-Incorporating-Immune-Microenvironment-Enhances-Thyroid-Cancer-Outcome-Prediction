...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P3544_SB_03.counts.hdf5 \
    --standardized-copy-ratios P3544_SB_03.standardizedCR.tsv \
    --denoised-copy-ratios P3544_SB_03.denoisedCR.tsv \
