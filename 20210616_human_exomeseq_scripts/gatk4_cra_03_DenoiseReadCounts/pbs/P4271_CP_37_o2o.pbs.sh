...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P4271_CP_37.counts.hdf5 \
    --standardized-copy-ratios P4271_CP_37.standardizedCR.tsv \
    --denoised-copy-ratios P4271_CP_37.denoisedCR.tsv \
