...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P6121_CP_39.counts.hdf5 \
    --standardized-copy-ratios P6121_CP_39.standardizedCR.tsv \
    --denoised-copy-ratios P6121_CP_39.denoisedCR.tsv \
