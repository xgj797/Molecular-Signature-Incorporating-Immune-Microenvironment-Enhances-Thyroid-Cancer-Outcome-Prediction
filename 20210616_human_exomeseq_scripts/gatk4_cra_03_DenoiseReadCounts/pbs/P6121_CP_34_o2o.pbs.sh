...
gatk --java-options "-Xmx40g" DenoiseReadCounts \
    -I /scratch/weissvl/shengq2/20210616_human_exomeseq/gatk4_cra_01_CollectReadCounts/result/P6121_CP_34.counts.hdf5 \
    --standardized-copy-ratios P6121_CP_34.standardizedCR.tsv \
    --denoised-copy-ratios P6121_CP_34.denoisedCR.tsv \
